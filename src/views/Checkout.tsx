                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                    <div>
                        ...
                        {touched.name && errors.name && (
                            <div id="name-error" className="flex items-center gap-1 mt-1 text-red-500 text-xs animate-fade-in-up">
                                <AlertCircle size={12} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            {touched.phone && errors.phone && (
                                <div id="phone-error" className="flex items-center gap-1 mt-1 text-red-500 text-xs animate-fade-in-up">
                                    <AlertCircle size={12} />
                        ...
                        <div>
                            ...
                            {touched.address && errors.address && (
                                <div id="address-error" className="flex items-center gap-1 mt-1 text-red-500 text-xs animate-fade-in-up">
                                    <AlertCircle size={12} />
                    ...
                    <div>
                        <label htmlFor="notes" className="block text-sm font-medium text-gray-700 mb-1">Notas Especiales (Opcional)</label>
                        <div className="relative">
